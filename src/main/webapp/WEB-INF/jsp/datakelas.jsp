		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="/all-kelas"> <i
							class="material-icons">local_library</i> <span>Kelas</span>
					</a></li>
	...
	<section class="content">
		<div class="body" style="margin-top: -30px;">
			<ol class="breadcrumb breadcrumb-bg-pink">
				<li><a href="javascript:void(0);"><i class="material-icons">local_library</i>
						Data Kelas</a></li>
			</ol>
		</div>
					...
					<c:choose>
						<c:when test="${mode == 'MODE_KELAS'}">
							<div class="body">
								...
								<div class="row clearfix">
									<div class="col-md-12">
										<a href="/new-kelas" class="btn btn-danger waves-effect right">
											...
											<c:forEach var="kelas" items="${kelass}">
												<tr>
													...
													<td style="text-align: center;"><a
														href="update-kelas?id_kelas=${kelas.id_kelas}"><i
															class="material-icons" style="color: blue;">create</i></a> <a
														href="delete-kelas?id_kelas=${kelas.id_kelas}"><i
						...
						<c:when test="${mode == 'MODE_NEW' || mode == 'MODE_UPDATE'}">
							...
							<form id="form_validation" action="save-kelas" method="post">
								<div class="body">
											...
											<div class="form-group form-float">
												...
												<div class="form-line">
													<input name="nama_kelas" type="text" class="form-control"
														required maxlength="10" value="${kelas.nama_kelas}">
												</div>
											</div>
										</div>
									</div>
