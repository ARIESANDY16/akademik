		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="all-krs"> <i
							class="material-icons">credit_card</i> <span>Kartu Rencana
								Studi</span>
					</a></li>
				</ul>
	...
	<section class="content">
		<div class="body" style="margin-top: -30px;">
			<ol class="breadcrumb breadcrumb-bg-pink">
				<li><a href="javascript:void(0);"><i class="material-icons">credit_card</i>
									...
									<c:forEach var="mhs" items="${mhss}">
										<tr>
											...
											<td style="text-align: center;"><a
												href="krs?id_mhs=${mhs.id_mhs}"><i
													class="material-icons" style="color: blue;">create</i></a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
