		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="/" class="navbar-toggle collapsed" data-toggle="collapse"
					...
					class="navbar-brand"><font size="6px;">Guru | SDS ISLAM AS SA'ADAH</font></a>
			</div>
				...
				<div class="card">
					<div class="body">
						<div class="container text-center">
							<h2>Data Mata Pelajaran Guru</h2>
							<hr>
						</div>
						<div class="table-responsive">
							...
							<sql:query var="sqlresult"
								sql="select * from md_matkul where id_dosen = '${id_dosen}'"
							...
							<table
								...
								<tbody>
									<c:forEach var="row" items="${sqlresult.rows}">
										<tr>
											<td><c:out value="${row.kd_matkul}" /></td>
											<td><c:out value="${row.nama_matkul}" /></td>
											<td style="text-align: center;"><a
												href="new-akademik?id_matkul=${row.id_matkul}"><i
