								...
								<ul class="menu">
									<li><a href="javascript:void(0);">
											...
											<div class="menu-info">
												...
												<p>${sessionScope.npm_mhs} | Student</p>
											</div>
									</a></li>
									<li><a href="/logout">
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="/data-mhs"> <i
							class="material-icons">person</i> <span>Data Siswa</span>
					</a></li>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					<div class="body">
						...
						<div class="row clearfix">
							<form id="form_validation" action="ubahprofile-mhs" method="post">
								<div class="body">
									<input type="hidden" name="id_mhs"
										value="${sessionScope.id_mhs}" />
									<div class="row clearfix">
										<div class="col-sm-3">
											<div class="form-group form-float">
												<label class="form-label">NPM</label>
												<div class="form-line">
													<input name="npm" style="background-color:#F5F5F5"	="text" class="form-control" required
														maxlength="8" value="${sessionScope.npm_mhs}" readonly>
												</div>
											</div>
										</div>
										<input type="hidden" name="kelas"
											value="${sessionScope.id_kelas}">
										<div class="col-sm-6">
											<div class="form-group form-float">
												<label class="form-label">Nama Lengkap</label>
												<div class="form-line">
													<input name="nama_mhs" style="background-color:#F5F5F5" type="text" class="form-control"
														value="${sessionScope.nama_mhs}" readonly required>
												</div>
											</div>
										</div>
									</div>
									<div class="row clearfix">
										<div class="col-sm-6">
											<div class="form-group form-float">
												...
												<div class="form-line">
													<input name="tempat_lahir" style="background-color:#F5F5F5" type="text" class="form-control"
														value="${sessionScope.tempat_lahir}" readonly required>
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											...
											<div class="input-group">
												<div class="form-line">
													<input name="tgl_lahir" style="background-color:#F5F5F5" type="date"
														class="form-control date" readonly
														value="<fmt:formatDate value="${sessionScope.tgl_lahir}" pattern="yyyy-MM-dd"/>" required>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group form-float">
												...
												<div class="form-line">
													<input name="alamat_mhs" type="text" class="form-control"
														value="${sessionScope.alamat_mhs}" required>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-sm-4">
											<div class="form-group form-float">
												<label class="form-label">Agama</label> <select
													...
													<option value="${sessionScope.agama_mhs}">${sessionScope.agama_mhs}</option>
											...
											<div class="form-group form-float">
												...
												<div class="form-line">
													<input name="password" type="password" class="form-control"
														value="${sessionScope.password_mhs}" required
														maxlength="20">
												</div>
											</div>
										</div>
									...
									<input type="submit"
										class="btn btn-primary waves-effect middle" value="Save" />
								</div>
							</form>
						</div>
					</div>
