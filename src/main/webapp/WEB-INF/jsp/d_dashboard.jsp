		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="/dosen-dashboard"> <i
			...
			<div class="legal">
				<div class="copyright">
					&copy; 2019 <a href="javascript:void(0);">SDS ISLAM AS SA'ADAH</a>.
				</div>
				<div class="version">
					<b>Version: </b> 1.0
				</div>
					...
					<div class="header">
						<div class="row clearfix">
							<div class="col-xs-12 col-sm-6">
								<h2>
									<i class="fa fa-fw fa-university"></i> | Guru | SDS ISLAM AS SA'ADAH
								</h2>
							</div>
						</div>
					</div>
					<div class="body" style="font-size: 16px;">Selamat Datang di web resmi
						SDS ISLAM AS SA'ADAH. Silahkan pergunakan informasi yang
