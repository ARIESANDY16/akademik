							...
							<div class="body">
								<div class="row clearfix">
									<input name="id_akademik" type="hidden" class="form-control"
										required value="${akademiks.id_akademik}">
									<div class="col-sm-8">
										<input name="mhs" type="hidden" class="form-control" required
											maxlength="8" value="${mhss.id_mhs}">
									...
									<div class="col-sm-8">
										<div class="form-group form-float">
											...
											<div class="form-line">
												<label>${mhss.nama_mhs}</label>
											</div>
										</div>
									</div>
								</div>
								<div class="row clearfix">
									<input name="matkul" type="hidden" class="form-control"
										required maxlength="8" value="${matkuls.id_matkul}">

									<div class="col-sm-4">
										<div class="form-group form-float">
											<label class="form-label">Mata Pelajaran</label>
											<div class="form-line">
												<label>${matkuls.nama_matkul}</label>
											</div>
										</div>
									</div>

									<input name="dosen" type="hidden" class="form-control" required
										maxlength="8" value="${sessionScope.id_dosen}">
										<div class="col-sm-4">
										<div class="form-group form-float">
											<label class="form-label">Nama Guru</label>
											<div class="form-line">
												<label>${sessionScope.nama_dosen}</label>
											</div>
										</div>
									</div>
								</div>
