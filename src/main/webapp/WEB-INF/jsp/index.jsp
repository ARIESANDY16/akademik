		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="menu">
				<ul class="list">
					...
					<li class="active"><a href="dashboard"> <i class="material-icons">dashboard</i>
							<span>Dashboard</span>
					</a></li>
					...
					<li><a href="all-data"> <i class="material-icons">person</i>
					...
					<div class="header">
						<div class="row clearfix">
							<div class="col-xs-12 col-sm-6">
								<h2>
									<i class="fa fa-fw fa-university"></i> | Guru | SD ISLAM AS SA'ADAH
								</h2>
							</div>
						</div>
					</div>
					<div class="body" style="font-size: 16px;">Selamat Datang di
						SDS ISLAM AS SA'ADAH Staffsite. Silahkan pergunakan informasi yang
