		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="/" class="navbar-toggle collapsed" data-toggle="collapse"
					...
					class="navbar-brand"><font size="6px;">Staffsite | SDS ISLAM AS SA'ADAH</font></a>
			</div>
					...
					<c:choose>
						<c:when test="${mode == 'MODE_DOSEN'}">
							<div class="body">
								...
								<div class="row clearfix">
									<div class="col-md-12">
										<a href="/new-dosen" class="btn btn-danger waves-effect right">
										...
										<tbody>
											<c:forEach var="dosen" items="${dosens}">
												<tr>
													...
													<td>${dosen.tl_dosen}</td>
													<td><fmt:formatDate value="${dosen.tgl_dosen}"
													...
													<td style="text-align: center;"><a
														href="update-dosen?id_dosen=${dosen.id_dosen}"><i
															class="material-icons" style="color: blue;">create</i></a> <a
														href="delete-dosen?id_dosen=${dosen.id_dosen}"><i
									...
									<div class="row clearfix">
										...
										<div class="col-sm-6">
											...
											<div class="input-group">
												<div class="form-line">
													<input name="tgl_dosen" type="date"
														class="form-control date" value="${dosen.tgl_dosen}"
														required>
												</div>
											</div>
										</div>
