		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<form id="form_validation" action="/save-update" method="post"
							...
							<div class="row clearfix">
								<div class="col-sm-2">
									<div class="form-group form-float">
										...
										<div class="form-line">
											<input name="npm" style="background-color:#F5F5F5" type="text" class="form-control" required
												maxlength="8" value="${mhs.npm}" readonly>
										</div>
									</div>
								</div>
								<div class="col-sm-2">
							...
							<div class="row clearfix">
								...
								<div class="col-sm-6">
									...
									<div class="input-group">
										<div class="form-line">
											<input name="tgl_lahir" type="text" class="form-control date"
												max="2001-07-01" readonly
												value="<fmt:formatDate value="${mhs.tgl_lahir}" pattern="yyyy-MM-dd"/>" required>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-sm-4">
									<div class="form-group form-float">
										<label class="form-label">Agama</label> <select
											...
											<option value="${mhs.agama_mhs}">${mhs.agama_mhs}</option>
								...
								<div class="col-sm-4">
									<div class="form-group form-float">
										<label class="form-label">Jenis Kelamin</label> <select
											...
											<option value="${mhs.gender}">${mhs.gender}</option>
